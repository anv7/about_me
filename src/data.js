...
export default {
  cn: {
    ...
    overview: {
      ...
      desList: ['我叫高航1，前端工程师一枚', '高级前端开发工程师', 'anvseven@gmail.com']
    },
    skill: {
      outCircleList: [
        {
    ...
    works: {
      worksList: [
        {
          title: '中仑收银机软件',
          des: '电商业务在微信小程序上的实现，包括普通商品，拼团商品的销售流程及购物流程、用户中心等模块。',
          mini: wJm
        },
        {
          title: '中国矿业大学90周年校庆会务平台',
          des: '微信小程序上的实现，包括专柜购区域选择及提货方式等全套销售流程及购物流程、用户中心等模块。',
          mini: wLs
        },
        {
          title: '竹简App(Hybird应用)',
          des: '聚美优品快应用是聚美集团电商业务在安卓快应用上的实现，基于手机硬件平台的新型应用形态，为销售途径提供新的渠道。',
          url: 'http://hapjs.org/app/com.jm.quickapp'
        },
        {
          title: '竹简App桌面版(Win、 MacOS版)',
          des: '核心承载者，包括前三页，购物流程，用户中心等，通过jsbridge部分页面也在app内广泛应用。',
          url: 'https://h5.jumei.com'
        },
        {
          title: '徐州招聘平台',
          des: '新增长投放项目，电商主要的推广活动承载页面，实现采用多页面架构，支持打包单一活动的工作模式。',
          url: 'http://www.xzzppt.com'
        },
        {
          title: '海港大宗crm后台管理系统',
          des: 'crm后台商户管理系统，包括各种商户录入，统计，维护等若干功能。',
          url: ''
        },
        {
          title: '中仑菜市场广告屏',
        ...
        {
          title: '中仑老板助手',
          des: '后台管理系统，包括人员架构，信息统计，权限设置，H5生产机，数据交换平台，各个模块的数据管理，反馈设置等等，为高校提供基于互联网运营的移动校园整体解决方案。',
          url: ''
        },
        {
